...
- (IBAction)removeDeviceTapped:(id)sender {
    UIAlertController *alertViewController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Are you sure to remove the device?", @"") message:NSLocalizedString(@"If the device is removed, you will not be able to control the device.", @"") preferredStyle:UIAlertControllerStyleActionSheet];
