...
- (void)detectDeviceAvailability {
    ...
    if (!isOnline) {
        ...
        [SVProgressHUD showWithStatus:NSLocalizedString(@"This device is offline. The control panel is unavailable.", @"")];
    } else {
...
-(void)deviceRemoved:(TuyaSmartDevice *)device {
    [[NSNotificationCenter defaultCenter] postNotificationName:kDeviceOffline object:nil];
    [SVProgressHUD showErrorWithStatus:NSLocalizedString(@"This device has been removed.", @"")];
}
