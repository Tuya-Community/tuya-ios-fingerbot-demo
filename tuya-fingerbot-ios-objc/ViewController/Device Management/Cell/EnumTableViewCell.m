...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    if (selected && self.optionArray > 0) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Select", @"") message:nil preferredStyle:UIAlertControllerStyleActionSheet];
